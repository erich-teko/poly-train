...
function ToastViewport({ className, ...props }: ToastPrimitive.Viewport.Props) {
  return (
    <ToastPrimitive.Viewport
      ...
      className={cn(
        "pointer-events-none fixed inset-x-4 bottom-4 z-50 mx-auto w-auto max-w-sm outline-none sm:inset-x-0 sm:left-1/2 sm:right-auto sm:-translate-x-1/2 sm:mx-0 sm:w-full",
        className
      )}
      {...props}
    />
